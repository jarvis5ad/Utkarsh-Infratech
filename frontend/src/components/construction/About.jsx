      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            {/* Decorative Elements */}
            <div className="absolute -bottom-6 -right-6 w-48 h-48 bg-orange-500 rounded-2xl -z-0" />
            <div className="absolute -top-6 -left-6 w-32 h-32 border-4 border-gray-200 rounded-2xl -z-0" />
            ...
            <motion.div
              ...
              className="absolute -bottom-4 left-8 bg-white rounded-xl shadow-xl p-6 z-20"
            >
          ...
          >
            ...
            <div className="flex items-center gap-4 pt-6 border-t border-gray-200">
              <div className="w-14 h-14 bg-gray-900 rounded-full flex items-center justify-center">
                <span className="text-orange-500 font-bold text-xl">U</span>
              </div>
              <div>
                <p className="font-bold text-gray-900">UTKARSH INFRATECH</p>
